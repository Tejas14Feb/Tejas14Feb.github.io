...
export const projects: Project[] = [
  {
    ...
    tags: ['Python', 'XGBoost', 'Pandas', 'DuckDB', 'Plotly Dash', 'Scikit-learn'],
    ...
    previewDesc:
      'Full ML pipeline: ingestion → EDA → 3 models → interactive Dash app. Predicts chart hits from audio features like danceability, energy, and valence across 114K Spotify tracks.',
  ...
  },
  {
    ...
    tags: ['Python', 'SciPy', 'Matplotlib', 'Seaborn', 'Bayesian Regression', 'NumPy'],
    ...
    previewDesc:
      'Models phosphorus C–Q relationships with full uncertainty quantification. Log-log scatter analysis and linearized regression on real discharge data.',
    cta: '↗ Open GitHub repo',
  },
  {
    ...
    tags: ['Python', 'PyTorch', 'LSTM', 'Scikit-learn', 'SQLite', 'Docker'],
    ...
    previewDesc:
      'LSTM Autoencoder vs Isolation Forest on simulated ECG wearable data. Full pipeline: streaming ingestion → SQLite → model training → evaluation dashboard.',
    cta: '↗ Open GitHub repo',
  },
  {
    type: 'Data Engineering',
    title: 'Job Market Pulse — ETL Pipeline & REST API',
    desc: 'Scraped and transformed real-world job posting data to extract in-demand Data Science skills, loaded into PostgreSQL, and exposed via documented FastAPI REST API.',
    tags: ['Python', 'PostgreSQL', 'FastAPI', 'Airflow', 'Docker', 'Postman'],
    href: 'https://github.com/Tejas14Feb/job-market-pulse',
    ariaLabel: 'ETL Pipeline and API for Data Science Skill Demand, opens GitHub',
    previewTitle: 'Job Market Pulse',
    previewImg: 'screenshots/jobmarket.png',
    previewAlt: 'Horizontal bar chart of top data science skills in job postings',
    previewDesc:
      'Python tops at 90%+ of postings. Full ETL: scrape → clean → PostgreSQL → FastAPI with Swagger docs. Automated with Airflow, containerized in Docker.',
    cta: '↗ Open GitHub repo',
  },
  {
    ...
    tags: ['Python', 'SQL', 'Airtable', 'Power BI', 'BatchGEO', 'ETL/ELT', 'Power Query'],
    ...
    previewDesc:
      'Live on SDMTS website. 2,671 manufacturers, 21 NAICS industries, 234 cities. BatchGEO mapping + Advanced Filters + Power BI dashboards. Reduced manual processing by 70%.',
    cta: '↗ View live site',
  },
]
