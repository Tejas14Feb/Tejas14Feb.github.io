...
function ProjectCard({
  ...
  return (
    <div className="admin-card">
      <button className="admin-card-header" onClick={onToggle}>
        <div>
        ...
        <div className="admin-card-body">
          ...
          <Field label="Tags">
            <TagInput
              tags={project.tags}
              placeholder="Add tag..."
              onChange={tags => onUpdate({ ...project, tags })}
            />
          </Field>
...
export default function AdminProjects() {
  ...
  const update = (idx: number, p: Project) =>
    setList(prev => prev.map((x, i) => i === idx ? p : x))
  ...
  const add = () => {
    setList(prev => [...prev, { ...BLANK }])
    setExpandedIdx(list.length)
  }
  ...
  return (
    <div className="admin-section">
      ...
      <button className="admin-btn-add" onClick={add}>+ Add project</button>
